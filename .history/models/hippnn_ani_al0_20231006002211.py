#PERFORM_PLOTTING = False # Make sure you have matplotlib if you want to set this to TRUE
...
with hippynn.tools.log_terminal("training_log.txt", 'wt'):
    ...
    loss_error=loss_energy + loss_forces
    ...
    database_params = {
        ...
        #'directory': '/Users/wei_li/Documents/codes/ANI1x_official',
        'directory':'/vast/projects/ml4chem/NikitaFedik/1_TPS/HIPNN_manual_AL/ani_tps_merged',
        'quiet': False,
        'test_size':0.1,
        'valid_size':0.1,
        'num_workers': 2,
    ...
    #database.send_to_device('cuda')
    #training_modules.model.to('cuda')
